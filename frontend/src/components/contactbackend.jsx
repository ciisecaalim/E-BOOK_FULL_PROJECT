...
function ContactsDashboard() {
  ...
  <table className="w-full min-w-[900px] table-auto bg-white">
    ...
    <tbody>
      {pageData.map((c) => (
        <tr key={c._id} className="border-b hover:bg-purple-50 transition-all hover:shadow-md">
          ...
          <td className="p-3 flex gap-2 items-center justify-center">
            ...
            {view === "inbox" && (
              <select
                className="px-3 py-1 border rounded-lg shadow-sm hover:border-purple-500 transition cursor-pointer"
                value={c.status}
